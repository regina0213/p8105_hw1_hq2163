...
####The first picture is a scatterplot of y vs x. The red spots represent x+y<0(vec_logical2=FALSE) and the green spots represent x+y>0(vec_logical2=TRUE).
...
####The second picture is a scatterplot of y vs x. The dark blue spots represent vec_numeric2=0 and the light blue spots represent vec_numeric2=1.

```{r}
ggplot(plot_df, aes(x , y, color = vec_factor2)) + geom_point()
```

####The third picture is a scatterplot of y vs x. The red spots represent vec_factor2=FALSE and the green spots represent vec_factor2=TRUE.
